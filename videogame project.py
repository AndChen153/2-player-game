...
andy = pygame.image.load('andy.jpg')
...
while not done:
        ...
        if pos not in coordinates:
            ...
            screen.blit(get_image('andy.jpg'), pygame.Rect(x, y, 40,40))
            if rp==True:
                screen.blit(get_image('cornright.jpg'), (x+50, y+20))
                screen.blit(get_image('andy.jpg'), (x, y))
            if lp==True:
                screen.blit(get_image('cornleft.jpg'), (x-30, y+20))
                screen.blit(get_image('andyleft.jpg'), (x, y))
            if dp==True:
                screen.blit(get_image('corndown.jpg'), (x+20, y+50))
                screen.blit(get_image('andydown.jpg'), (x, y))
            if up==True:
                screen.blit(get_image('cornup.jpg'), (x+20, y-30))
                screen.blit(get_image('andyup.jpg'), (x, y))
        elif dp==True:
            y=y-2
            screen.blit(get_image('corndown.jpg'), (x+20, y+50))
            screen.blit(get_image('andydown.jpg'), (x, y))
